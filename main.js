...
class Explorable {
    constructor() {
        this.nameEl = el("span", { class: "explorable-path" });
    ...
    update(data, index, items) {
        ...
        this.nameEl.textContent = file.name || path;
