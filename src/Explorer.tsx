...
class Explorable {
    nameEl: HTMLSpanElement = <span class="explorable-path"/>;
    sepEl: HTMLSpanElement = <span class="explorable-separator">/</span>
    el: HTMLSpanElement = <span draggable class="explorable titlebar-button">{this.nameEl}{this.sepEl}</span>;   
